...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Prague, CZ / Copenhagen, DK}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Volunteering Experience}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                \item Participated in a total of 8 student-led conferences in Czechia and abroad and organized a 4-day conference for 120 participants.
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            \textbf{Programming languages}: Rust, JavaScript, TypeScript, Python, C++
        \end{onecolentry}
